...
const StartScreen: React.FC<StartScreenProps> = ({ onFileSelect }) => {
  ...
  return (
    <div 
      className={`w-full max-w-5xl mx-auto text-center p-8 transition-all duration-300 rounded-2xl border-2 ${isDraggingOver ? 'bg-blue-900/20 border-dashed border-blue-500 scale-105' : 'border-transparent'}`}
